...
public class BDService {
	...
	public void instantiateTesteDataBase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria silva", "adrianosantos.cursos@gmail.com", "363789127330",
				TipoCliente.PessoaFisica, pe.encode("1237"));
		cli1.addPerfil(Perfil.CLIENTE);
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Rosa", "aadriano990@gmail.com", "31628382740", TipoCliente.PessoaFisica,
				pe.encode("123"));
		...
		Pagamento pg2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("20/10/2017 19:54"),
				null);
