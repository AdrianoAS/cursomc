package com.adrianoSantos.curosmc.service.validation.utils;
...
public class BR {
	...
	*/
	public static boolean isValidCPF(final String ssn) {
		...
		return ssn.equals(ssn.substring(0,9) + digit1.toString() + digit1.toString());
	}
	...
	*/
	public static boolean isValidCNPJ(final String tin) {
		...
		return tin.equals(tin.substring(0,12) + digit1.toString() + digit1.toString());
	}
